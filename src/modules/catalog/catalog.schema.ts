...
ProductRef.implement({
  fields: (t) => ({
    ...
    grahas: t.exposeStringList("grahas", {
      description: "Graha slugs (sun, moon, mars, mercury, jupiter, venus, saturn, rahu, ketu) this gemstone/product is associated with.",
    }),
